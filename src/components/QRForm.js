...
function QRForm({ setQrCodeUrl }) { // Receive setQrCodeUrl as a prop
  ...
  const generateQRCode = async (e) => {
    ...
    try {
      ...
      // Navigate to QRCodeDisplay with the generated QR code URL
      navigate("/qr-code", { state: { qrCodeUrl: response.data.qrCodeUrl } });
    } catch (error) {
